          ...
          <div className="page use-reducer">
               ...
               <div className="btn-groups">
                    <div className="btn-group">
                         ...
                         <button
                              onClick={() => dispatch({ type: "INCREMENT_H" })}
                         >
                              ➕
                         </button>
                         <button
                              onClick={() => dispatch({ type: "DECREMENT_H" })}
                         >
                              ➖
                         </button>
                    </div>
                    <div className="btn-group">
                         ...
                         <button
                              onClick={() => dispatch({ type: "INCREMENT_S" })}
                         >
                              ➕
                         </button>
                         <button
                              onClick={() => dispatch({ type: "DECREMENT_S" })}
                         >
                              ➖
                         </button>
                    </div>
                    <div className="btn-group">
                         ...
                         <button
                              onClick={() => dispatch({ type: "INCREMENT_L" })}
                         >
                              ➕
                         </button>
                         <button
                              onClick={() => dispatch({ type: "DECREMENT_L" })}
                         >
                              ➖
                         </button>
                    </div>
